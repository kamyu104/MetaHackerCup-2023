...
|F| [Cacti Cartography](https://www.facebook.com/codingcompetitions/hacker-cup/2023/final-round/problems/F)| [Python3](./Final%20Round/cacti_cartography.py3) [Python3](./Final%20Round/cacti_cartography2.py3) | _O(N^2 * L)_ | _O(N^2)_  | Hard | | Cactus Graph, BFS, DFS, Tree DP, Linear Programming |
