...
|E| [Bohemian Rap-sody](https://www.facebook.com/codingcompetitions/hacker-cup/2023/round-1/problems/E)| [PyPy3](./Round%201/bohemian_rapsody.py3) | _O(QlogN + QlogQ + (L + Q) * sqrt(N))_ | _O(Q + T)_ | Hard | | Trie, Binary Search, Offline Queries, Sqrt Decomposition, `Mo's Algorithm`, Freq Table, Prefix Sum, Math |
